(function (window, document, $, undefined) {
    ...
    var tekzowJs = {
        ...
        methods: function (e) {
            tekzowJs.smothScroll();
            tekzowJs.backToTopInit();
            tekzowJs.backToTopInit();
            tekzowJs.counterUpActivation();
            tekzowJs.wowActivation();
            tekzowJs.headerTopActivation();
            tekzowJs.headerSticky();
            tekzowJs.salActive();
            tekzowJs.popupMobileMenu();
            tekzowJs.masonryActivation();
            tekzowJs.magnigyPopup();
            tekzowJs.lightBoxJs();
            tekzowJs.slickSliderActivation();
            tekzowJs.radialProgress();
            tekzowJs.contactForm();
            tekzowJs.menuCurrentLink();
            tekzowJs.onePageNav();
            tekzowJs.darkLight();
        },
